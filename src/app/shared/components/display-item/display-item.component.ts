...
@Component({
  ...
  standalone:true,
  imports:[IonGrid,IonRow,IonCol,IonImg,ShareSongComponent,LikeSongComponent,SongOptionComponent,PlaySongPage,PlaylistContainerComponent,MusicContainerComponent],
})
export class DisplayItemComponent  implements OnInit {
  ...
  isPlaylist(item: any): item is IPlaylist {
    return item && typeof item === 'object' && 'id' in item && 'name' in item && 'songs' in item;
  }
